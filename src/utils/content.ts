    ...
    TABS: [
      {
        name: 'Buy',
        image: Phone1Img,
        subtitle: 'Buy crypto with your bank card using our partner fiat gateway providers.'
      },
      {
        name: 'Store',
        image: Phone3Img,
        subtitle: 'Your crypto is protected with the most sophisticated security measures.'
      },
      {
        name: 'Transfer',
        image: Phone5Img,
      ...
      },
      {
        name: 'Stake',
        image: Phone2Img,
        subtitle: 'Stake 1INCH to participate in network governance and be eligible for gas costs refunds.'
      }
    ]
  },
  BannerBgImage,
...
export const section3Content = {
  title1: '1inch products',
  ITEMS1: [
    {
      title: 'Aggregation Protocol',
      subtitle: 'Liquidity aggregation from multiple DEXes to ensure the best swap rates.',
      image: Sec6Image1
    },
    {
      title: 'Limit Order Protocol',
      subtitle: 'The most innovative and flexible limit order functionality in DeFi.',
      image: Sec6Image2
    },
    {
      title: 'Liquidity Protocol',
      subtitle: 'A next-generation AMM that offers capital efficiency to liquidity providers.',
      image: Sec6Image3
    },
    {
      title: '1inch Earn',
      subtitle: 'A derivative-based product offering liquidity providers attractive APYs.',
      image: Sec6Image4
    },
    {
  ...
  title2: 'Grow with our ecosystem',
  subtitle2: 'Build solutions alongside decentralized finance leaders',
  ITEMS2: [
    {
      title: '1inch API',
      subtitle:
  ...
  title3: 'Your decentralized finance shield',
  subtitle3: "1inch uses sophisticated security measures to protect users' funds in swaps on other DeFi protocols",
  caption3: '1inch is the most audited project in DeFi. See a list of the most important smart contract audits here.',
  ShieldImage
}

export const section4Content = {
  title1: 'Empowered by the community',
  ITEMS1: [
    {
      title: '1inch DAO',
      subtitle: 'A governance tool that enables 1INCH stakers to vote for key protocol parameters.',
      image: Sec9Image1
    },
    {
      title: '1INCH token',
      subtitle: "A token that facilitates 1inch protocol governance and participation in the network's evolution.",
      image: Sec9Image2
    }
  ],
  SOCIALS: [
  ...
  title2: 'Partners and stakeholders',
  ITEMS2: [
    {
      link: 'https://near.org/',
      image: Near
...
export const footerContent = {
  protocols: {
    title: 'Protocols',
    links: [{ title: 'Liquidity Protocol' }, { title: 'Aggregation Protocol' }, { title: 'Limit Order Protocol' }]
  },
  governance: {
    title: 'Governance',
    links: [{ title: '1inch DAO' }, { title: '1INCH token' }, { title: 'Forum' }]
  },
  support: {
    title: 'Support',
    links: [
  ...
  developers: {
    title: 'Governance',
    links: [{ title: 'Documentation' }, { title: 'GitHub' }, { title: 'Audit' }, { title: 'Bug bounty' }]
  },
  subscribe: {
